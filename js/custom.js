...
function openNav() {
	...
	if (nav) {
		lastFocusedMenuElement = document.activeElement;
		nav.style.width = "100%";
		nav.setAttribute("aria-hidden", "false");

		var focusableElements = getNavFocusable(nav);
	...
	var toggle = document.querySelector(".menu_toggle_btn");
	if (toggle) {
...
function closeNav() {
	...
	if (lastFocusedMenuElement && document.contains(lastFocusedMenuElement)) {
		lastFocusedMenuElement.focus();
	} else if (toggle) {
		toggle.focus();
	}
}
